...
public class BoxedVertical extends View{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mDefaultValue = a.getInteger(R.styleable.BoxedVertical_defaultValue2, mDefaultValue);
            ...
            if (mImageEnabled){
                ...
                mDefaultImage = getBitmapFromDrawable(Objects.requireNonNull(a.getDrawable(R.styleable.BoxedVertical_defaultImage)));
                mMinImage = getBitmapFromDrawable(Objects.requireNonNull(a.getDrawable(R.styleable.BoxedVertical_minImage)));
                mMaxImage = getBitmapFromDrawable(Objects.requireNonNull(a.getDrawable(R.styleable.BoxedVertical_maxImage)));
            }
